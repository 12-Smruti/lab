...
to quickly look up client‘s telephone number. Make use of 2 collision techniques (like
linear probing and quadratic probing) and compare them using no. of comparisons required
to find a set of telephone number
*/
